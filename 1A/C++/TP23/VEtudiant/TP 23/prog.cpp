...
int main(void)
{
  ...
  NOTICE("Construction tests");
  {
    ...
    CCircularBuffer<unsigned char> defBuf;
    ...
    catch (CCircularBufferError e) { // Récupère une erreure de type CCircularBufferError et vérifie qu'elle possède les caractéristiques suivantes : CCircularBufferError::ErrorCodes::NotEnoughFreeSpace
        TEST("Test que l'exception possède les caractéristiques suivantes : ", e.errorCode(), CCircularBufferError::ErrorCodes::NotEnoughFreeSpace);
    }
    
  }
  {
    CCircularBuffer<unsigned char> buf256(256);
  ...
  }
  {
    ...
    try {
        CCircularBuffer<unsigned char> buf(3);
    }
    catch (CCircularBufferError e) { // Récupère une erreure de type CCircularBufferError et vérifie qu'elle possède les caractéristiques suivantes : CCircularBufferError::ErrorCodes::SizeIsNotPowerOf2
        TEST("Test que l'exception possède les caractéristiques suivantes : ", e.errorCode(), CCircularBufferError::ErrorCodes::SizeIsNotPowerOf2);
    }
  }
  ...
  CCircularBuffer<unsigned char> buf16(16);
  ...
  std::vector<int> unrolledData{ 255 };
  std::vector<int> validateUnrolledData{ 255 };
