...
public : 
	...
	static pEdge NewEdge(CNode::pNode pNode1, CNode::pNode pNode2, typeWeight weight = 0); // permet de créer un nouveau pEdge à partir de 2 pNode et d un poids et le renvoie
